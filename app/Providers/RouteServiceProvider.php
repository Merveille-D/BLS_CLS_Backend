    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            Route::middleware('api')
                ...
                ->group(base_path('routes/V1/contract/task.php'))
                ->group(base_path('routes/V1/contract/model.php'))
                ->group(base_path('routes/V1/contract/part.php'))
                ->group(base_path('routes/V1/contract/category.php'))
                ->group(base_path('routes/V1/contract/type_category.php'))
                ->group(base_path('routes/V1/contract/sub_type_category.php'))
