...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="center" style="margin-top: 10px;">
            ...
            <p class="subtitle bold">{{$data['collaborator']['lastname']}} {{$data['collaborator']['firstname']}}</p>
            <p class="subtitle italic underline">{{ $data['evaluation_reference'] }}</p>
        ...
        <table class="data-table">
            ...
            <tbody>
                @foreach ($item['notation']['indicators'] as $item )
                    <tr>
                        <td>{{ $item['performance_indicator']['title'] }}</td>
                        <td>{{ $item['note'] ?? '_'  }}</td>
                    </tr>
                @endforeach
