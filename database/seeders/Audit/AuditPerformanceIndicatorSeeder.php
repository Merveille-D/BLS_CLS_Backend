    ...
    public function run()
    {
        ...
        $indicators = [
            [
                ...
                'items' => [
                    [
                        'title' => 'Bonne qualification professionnelle',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Solides compétences et connaissance démontrables de l’environnement juridique',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Préférence pour un cabinet spécialisé en droit bancaire, transactions commerciales, financement de projets, télécoms, énergie et travail',
                        'note' => 5,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    ...
                    [
                        'title' => 'Diffusion du bureau du cabinet d’avocats dans les régions géographiques du pays',
                        'note' => 3,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Proximité du cabinet d’avocats avec les dossiers traités, notamment les dossiers de recouvrement',
                        'note' => 2,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Organisation du bureau, Outils de communication bureautique standard et Informatisation des opérations',
                        'note' => 2,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Capacité à sécuriser et à conserver des informations confidentielles',
                        'note' => 3,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Nombre d’associés, de collaborateurs et de personnel administratif',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Réputation du cabinet d’avocats dans la profession',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Expérience dans la gestion réussie de transactions complexes',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Liste des affaires critiques clés qui ont été traitées avec succès par le cabinet d’avocats à la Haute Cour, à la Cour d’appel / Cour suprême',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
                    [
                        'title' => 'Considérations sociales/politiques & Activité stratégique que la banque a à gagner en engageant le cabinet',
                        'note' => 10,
                        'type' => 'quantitative',
                        'description' => 'Description',
                    ],
